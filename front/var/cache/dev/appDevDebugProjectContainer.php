...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('GAkouIgEZr', 0, 'JL0wtF5QYoA2Y6UsLvyYH-', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['github_authenticator'] = new \AppBundle\Security\GithubAuthenticator($this->get('csa_guzzle.client.github_oauth'), 'your_github_client_id', 'your_github_secret', $this->get('router'));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addGlobal('github_client_id', 'your_github_client_id');
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('2CaDNqZ1l1', 0, 'JL0wtF5QYoA2Y6UsLvyYH-', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
